    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('${devis.nom} ${devis.prenom}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 5),
            Text('Tarif: ${devis.tarif}'),
            Text('Email: ${devis.email}'),
            Text('Adresse: ${devis.adresse}'),
            Text('Code Postale: ${devis.codePostale}'),
            Text('Num Tel: ${devis.numTel}'),
